...
const ProductDetail = ({ IsOpen,IsClose}) => {
                ...
                <div className="mb-4 flex flex-row justify-around flex-wrap">
                  ...
                  <span className="mb-4 ">
                    ...
                    <button
                      ...
                      className={`text-black size-btn ${selectedSize === "S" && "selected"
                    ...
                    <button
                      ...
                      className={`text-black size-btn ${selectedSize === "M" && "selected"
                        } bg-gray-200 m-1 p-1 hover:bg-yellow-500 hover:text-white`}
                    >
                      M
                    </button>
                    <button
                      ...
                      className={`text-black size-btn ${selectedSize === "L" && "selected"
                        } bg-gray-200 m-1 p-1 hover:bg-yellow-500 hover:text-white`}
                    >
                      L
                    </button>
                  ...
                  <span className="mb-4 ">
                    ...
                    <button
                      ...
                      className={`text-black size-btn ${selectedPattern === "W" && "selected"
                        } bg-gray-200 m-1 p-1 hover:bg-yellow-500 hover:text-white`}
                    >
                      WAXY
                    </button>
                    <button
                      ...
                      className={`text-black size-btn ${selectedPattern === "C" && "selected"
                        }  bg-gray-200 m-1 p-1 hover:bg-yellow-500 hover:text-white`}
                    >
                      CURVY{" "}
                    </button>
                    <button
                      ...
                      className={`text-black size-btn ${selectedPattern === "S" && "selected"
                        } bg-gray-200  m-1 p-1 hover:bg-yellow-500 hover:text-white`}
                    >
                      SHINNY
                    </button>
